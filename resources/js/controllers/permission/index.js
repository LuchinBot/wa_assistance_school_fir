         ...
         <tr style="border-bottom: 1px solid #f1f5f9; transition: background 0.1s;"
            ...
            onmouseout="this.style.background=''">
                    ...
                    <td class="px-5 py-3 text-xs">
                       <div><span class="font-semibold text-slate-500">Padre:</span> ${record.module.parent?.name_large ?? "Sin padre"}</div>
                        <div class="font-normal text-gray-500">
                            <span class="font-semibold text-slate-500">Hijo:</span>: ${record.module.name_large ?? "-"}
                        </div>
                    </td>
                    ...
                    <td class="px-5 py-3 text-xs">
                      ...
                      <td class="px-5 py-3 text-xs">
                        ${record.description ?? "Sin registrar"} 
                    </td>
                    <td class="px-6 py-4">
                        ...
                        <div class="flex items-start justify-between gap-3">
                            ...
                            <div class="flex-shrink-0 flex flex-col items-end gap-1">
                                <span class="text-xs font-semibold px-2.5 py-1 rounded-full"
                                    ...
                                    ${record.module?.name_large ?? "-"}
                                </span>
                                <span class="text-xs px-2.5 py-1 rounded-full"
                                    style="background: rgba(100,116,139,0.08); color: #64748b;">
                                    ${record.module?.parent?.name_large ?? "Sin padre"}
                                </span>
                            </div>

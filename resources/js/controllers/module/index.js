         ...
         <tr style="border-bottom: 1px solid #f1f5f9; transition: background 0.1s;"
            ...
            onmouseout="this.style.background=''">
                    <td class="px-5 py-3 text-xs">
                        <span class="material-symbols-outlined text-[15px] text-slalte-500">${record.icon ?? "-"}</span> 
                    </td>
                    <td class="px-5 py-3 text-xs font-semibold">
                        
                        <div>${record.name_large}</div>
                        <div class="font-normal text-gray-500">
                            ${record.parent?.name_large ?? "-"} 
                        </div>                    </td>
                     <td class="px-5 py-3 text-xs">
                         ${record.created_at}
                    </td>
                    ...
                    <div class="p-4">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div class="w-10 h-10 rounded-lg flex items-center justify-center flex-shrink-0"
                                style="background: rgba(0,176,202,0.10);">
                                <span class="material-symbols-outlined"
                                    style="font-size: 20px; color: rgb(0,140,165);">
                                    ${record.icon ?? "widgets"}
                                </span>
                            </div>
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="text-xs text-slate-400 mt-0.5">
                                    ${record.codmodule_parent?.name_large ?? "-"}
                                </p>
                            </div>

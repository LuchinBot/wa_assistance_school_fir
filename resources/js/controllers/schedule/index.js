         ...
         <tr style="border-bottom: 1px solid #f1f5f9; transition: background 0.1s;"
            ...
            onmouseout="this.style.background=''">
                    ...
                    <td class="px-5 py-3 text-xs">
                        <div class="font-medium text-slate-700">${record.turn}</div>
                    </td>
                    <td class="px-5 py-3 text-xs">                       
                         <div class="flex">
                        ...
                        <div class="flex items-center justify-between gap-3">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="text-xs text-slate-400 mt-0.5">
                                    De ${record.time_start ?? "-"} hasta ${record.time_end ?? "-"}
                                </p>
                            </div>

                            <!-- Horario badge -->
                            <div class="flex-shrink-0 flex items-center gap-1 text-xs font-semibold px-3 py-1 rounded-full"

...
export default function () {
    ...
    const engine = new TableEngine({
        ...
        extraParams: () => ({
            ...
            grade_schedule: sectionFilter?.value ?? "", // ← correcto
        }),
        ...
        createRow(record) {
            ...
            const student = currentTab === "absent" ? record : record.student;
    ...
    function reload() {
        engine.state.currentPage = 1;
        engine.loadRecords(0, engine.config.recordsPerPage);
    }

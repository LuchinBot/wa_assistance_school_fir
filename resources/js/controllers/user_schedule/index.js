         ...
         <tr style="border-bottom: 1px solid #f1f5f9; transition: background 0.1s;"
            ...
            onmouseout="this.style.background=''">
                    ...
                    <td class="px-5 py-3 text-xs">
                        <strong>${record.user.username}</strong> - ${record.user.person.firstname} ${record.user.person.lastname_father}
                    </td>
                    <td class="px-5 py-3 text-xs">
                    ...
                    <td class="px-6 py-4">
                        <div class="flex justify-center gap-1.5">
                            ...
                            onmouseout="this.style.background=''; this.style.color='#64748b';"
                                data-id="${record.coduser_schedule}" 
                                title="Editar">

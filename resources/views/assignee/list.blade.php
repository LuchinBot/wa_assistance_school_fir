...
@section('content')
    ...
    <div class="">
        ...
        <div class="px-6 lg:px-10 py-6">
            ...
            {{-- TABLA --}}
            <div id="tableContainer" class="bg-white overflow-hidden relative" style="border: 1px solid #e8edf2; border-radius: 0 0 8px 8px;">
                ...
                <div class="overflow-x-auto custom-scrollbar">
                    <table id="recordContainer" class="w-full text-left min-w-[640px]">
                        <thead>
                            <tr style="border-bottom: 1px solid #e8edf2; background: #f8fafc;">
                                <th class="px-5 py-3 text-xs font-semibold text-gray-500">Nombre y apellidos</th>
                                <th class="px-5 py-3 text-xs font-semibold text-gray-500">Parentesco</th>
                ...
                {{-- PAGINACIÓN --}}
                <div id="paginationContainer" class="px-5 py-3 bg-slate-50/50" style="border-top: 1px solid #e8edf2;"></div>
            </div>
    ...
    {{-- MODAL IMAGEN --}}
    <div id="modal-image-main" class="fixed inset-0 z-[110] hidden overflow-hidden"
        ...
        <span
            ...
            onclick="$('#modal-image-main').fadeOut();" onmouseover="this.style.color='rgb(0,176,202)'"

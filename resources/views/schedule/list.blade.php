                    ...
                    <table id="recordContainer" class="hidden md:table w-full text-left min-w-[640px]">
                        <thead>
                            <tr style="border-bottom: 1px solid #e8edf2; background: #f8fafc;">
                                <th class="px-5 py-3 text-xs font-semibold text-gray-500">Turno</th>
                                <th class="px-5 py-3 text-xs font-semibold text-gray-500">Hora inicio</th>
                                <th class="px-5 py-3 text-xs font-semibold text-gray-500">Hora fin</th>

                ...
                <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div class="space-y-1.5">
                        ...
                        <p class="text-xs text-gray-500 mt-0.5 font-normal">
                            Consulta el resumen de asistencia entre fecha.
                        </p>
                    </div>

                    <div class="flex flex-col sm:flex-row gap-2 flex-shrink-0">
                        <button id="btn-export-pdf"
                            class="inline-flex items-center justify-center gap-1.5 px-4 py-2 text-white text-sm rounded-lg transition-all duration-200 active:scale-95 w-max"

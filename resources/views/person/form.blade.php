    ...
    <div class="bg-white px-6 lg:px-10 py-4 flex items-center gap-4" style="border-bottom: 1px solid #e8edf2;">
        ...
        <div class="flex items-center gap-2 text-sm">
            ...
            <span class="font-semibold text-slate-700">
                {{ isset($person) ? 'Editar registro' : 'Nuevo registro' }}
            </span>
        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
                        ...
                        <div class="md:col-span-3 flex flex-col items-center gap-4 pb-6 md:pb-0 md:pr-6 border-b md:border-b-0 md:border-r"
                            ...
                            <div id="photoPreview"
                                ...
                                @if (isset($person) && $person->photo_url)
                                    <img src="{{ $person->photo_url }}" alt="Foto" class="w-full h-full object-cover">
                                @else
                                    <div class="flex flex-col items-center justify-center p-4 text-center">
                                        <span class="material-symbols-outlined text-[40px] mb-1" style="color: #cbd5e1;">account_circle</span>
                                        <p class="text-[9px] font-bold uppercase tracking-tight" style="color: #94a3b8;">Sin Foto</p>
                                    </div>
                                @endif
                            </div>
                            ...
                            <p class="text-[9px] font-medium uppercase tracking-wide" style="color: #94a3b8;">JPG, PNG · Máx. 2MB</p>
                        </div>
                        ...
                        <div class="md:col-span-9 space-y-4">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div class="space-y-1.5">
                                    ...
                                    <div class="relative">
                                        <input type="text" id="identify_number" name="identify_number"
                                            ...
                                            onfocus="this.style.borderColor='rgba(0,176,202,0.5)'; this.style.boxShadow='0 0 0 3px rgba(0,176,202,0.08)';"
                                            onblur="this.style.borderColor='#e2e8f0'; this.style.boxShadow='none';">
                                        <button type="button" id="btnDocument" {{ isset($person) ? 'disabled' : '' }}
                                ...
                                {{-- Apellido Paterno --}}
                                <div class="space-y-1.5">
                                    <label for="lastname_father" class="flex items-center gap-1 text-xs text-slate-500">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                        ...
                        <div class="space-y-1.5">
                            ...
                            <input type="email" id="email" name="email"
                                value="{{ $person->email ?? '' }}" placeholder="correo@web.com"
                                class="w-full h-10 px-3.5 text-sm text-slate-700 rounded-md outline-none transition-all duration-200"
                                style="background: #f8fafc; border: 1px solid #e2e8f0;"
                                onfocus="this.style.borderColor='rgba(0,176,202,0.5)'; this.style.boxShadow='0 0 0 3px rgba(0,176,202,0.08)';"
                                onblur="this.style.borderColor='#e2e8f0'; this.style.boxShadow='none';">
                        ...
                        <div class="space-y-1.5">
                            ...
                            <input type="tel" id="phone" name="phone"
                                value="{{ $person->phone ?? '' }}" placeholder="930226745"
                                class="w-full h-10 px-3.5 text-sm text-slate-700 rounded-md outline-none transition-all duration-200"
                                style="background: #f8fafc; border: 1px solid #e2e8f0;"
                                onfocus="this.style.borderColor='rgba(0,176,202,0.5)'; this.style.boxShadow='0 0 0 3px rgba(0,176,202,0.08)';"
                                onblur="this.style.borderColor='#e2e8f0'; this.style.boxShadow='none';">
                ...
                <div class="px-6 py-4 flex flex-col-reverse sm:flex-row items-center justify-between gap-3"
                    ...
                    <div class="flex items-center gap-2 w-full sm:w-auto">
                        ...
                        <button type="submit" id="btnSubmit"
                            ...
                            <span id="btnSubmitText">{{ isset($person) ? 'Actualizar Registro' : 'Guardar Persona' }}</span>
                        </button>
                    </div>
                </div>

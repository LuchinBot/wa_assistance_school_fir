...
@section('content')
    ...
    <div class="">
        <div class="px-6 lg:px-10 py-6">
            ...
            <div class="bg-white px-4 py-3 mb-0 flex items-center gap-3"
                ...
                <div class="flex items-center gap-2 px-3 py-1.5 rounded-md w-72"
                ...
                <p class="text-xs font-medium hidden sm:block" style="color: #94a3b8;">
                    <span class="font-black text-slate-600" id="totalRecord">{{ $extend['totalRecord'] }}</span> registros
                </p>
            </div>
                    ...
                    <table id="recordContainer" class="hidden md:table w-full text-left min-w-[640px]">
                        <thead>
                            <tr style="border-bottom: 1px solid #e8edf2; background: #f8fafc;">
                                ...
                                <th class="px-5 py-3 text-xs font-semibold text-gray-500">Rol asignado</th>
                                <th class="px-5 py-3 text-xs font-semibold text-gray-500">Persona natural</th>
                                <th class="px-5 py-3 text-xs font-semibold text-gray-500">Fecha de creación</th>
    ...
    <div id="resetModal"
        ...
        <div class="modal-content scale-95 opacity-0 w-full max-w-[340px] bg-white rounded-xl overflow-hidden transition-all duration-300 delay-75"
            ...
            <div class="px-5 py-4 flex items-center gap-3" style="border-bottom: 1px solid #f1f5f9;">
                <div class="w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0"
                    ...
                    <span class="material-symbols-outlined text-[17px]" style="color: rgb(249,115,22);">lock_reset</span>
                </div>
                <div>
                    <p class="text-sm font-black text-slate-800 leading-none">¿Resetear contraseña?</p>
                    <p class="text-[11px] text-slate-400 mt-0.5">Se restablecerán los valores por defecto</p>
                </div>
            </div>

            <div class="px-5 py-4">
                <p class="text-sm text-slate-500 leading-relaxed">
                    ¿Estás seguro de que deseas resetear la clave de este usuario?
                </p>
            </div>

            <div class="px-5 pb-4 flex gap-2">
                <button id="btnCancelReset"
                ...
                <button id="btnConfirmReset"
                    ...
                    style="background: rgb(249,115,22);" onmouseover="this.style.background='rgb(234,88,12)';"
                    onmouseout="this.style.background='rgb(249,115,22)';">
                    Confirmar
                </button>
            </div>
        </div>
